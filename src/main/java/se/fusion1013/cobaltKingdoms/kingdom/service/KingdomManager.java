package se.fusion1013.cobaltKingdoms.kingdom.service;
...
import se.fusion1013.cobaltKingdoms.kingdom.model.KingdomPermission;
...
public class KingdomManager extends Manager<CobaltKingdoms> implements Listener {
    ...
    public Response deleteKingdom(String kingdomName) {
        ...
        IKingdomRepository kingdomDao = DataManager.getInstance().getDao(IKingdomRepository.class);
    ...
    public Response leaveKingdom(@NotNull UUID playerId) {
        ...
        IKingdomRepository kingdomDao = dataManager.getDao(IKingdomRepository.class);
